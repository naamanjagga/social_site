...
<div class="container mx-5 px-5">
    <form action="backend.php" method="POST">
        ...
        <!-- Email input -->
        <div class="form-outline mb-4">
            <input type="file" id="form4Example2" name="video" class="form-control" />
            <label class="form-label" for="form4Example2">choose a video</label>
        </div>

        <!-- Message input -->
        <div class="form-outline mb-4">
            <textarea class="form-control" name="caption" id="form4Example3" rows="4"></textarea>
        ...
        <!-- Submit button -->
        <button type="submit" name="upload" class="btn btn-primary btn-block mb-4">Send</button>
    </form>
    </div>

    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            ...
            <input type="text" class="p-2" name="search" placeholder="Search">
                <button type="submit" class="btn btn-lg bg-danger mx-3" name="search_btn">Search</button>
            </form>
...
if (isset($_POST['search_btn'])) {
    ...
    $input_name = $_SESSION['search'];
    $user = User::find_by_username($input_name);
    if ($user != null) {
        echo '<div class="card" style="width: 18rem;">
        <img class="card-img-top" src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="Card image cap">
        <div class="card-body">
        ...
        $user = User::find_by_email($input_name); {
            if ($user != null) {
                echo '<div class="card" style="width: 18rem;">
                <img class="card-img-top" src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="Card image cap">
                <div class="card-body">

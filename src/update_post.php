...
<div class="container mx-5 px-5">
    ...
    <div class="form-outline mb-4">
            <input type="text" id="form4Example1" value="<?php echo $_SESSION['u_id']; ?>"  name="u_id" class="form-control" disabled />
            <label class="form-label"  for="form4Example1" >choose an image</label>
        </div>
        <!-- Name input -->
        <div class="form-outline mb-4">
            <input type="file" id="form4Example1" name="u_image" class="form-control" />
            <label class="form-label"  for="form4Example1">choose an image</label>
        </div>

        <!-- Email input -->
        <div class="form-outline mb-4">
            <input type="file" id="form4Example2" name="u_video" class="form-control" />
            <label class="form-label" for="form4Example2">choose a video</label>
        </div>

        <!-- Message input -->
        <div class="form-outline mb-4">
            <textarea class="form-control" name="u_caption" id="form4Example3" rows="4"><?php echo $_SESSION['u_caption']; ?></textarea>
            <label class="form-label"  for="form4Example3">write something</label>
        </div>
